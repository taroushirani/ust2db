...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    ...
    grep _かんかかきかくか.raw_E4 data/list/utt_list.txt > data/list/$eval_set.list
    grep _とぅんとぅとぅてとぅととぅ.raw_E4 data/list/utt_list.txt > data/list/$dev_set.list
    grep -v _かんかかきかくか.raw_E4 data/list/utt_list.txt | grep -v とぅんとぅとぅてとぅととぅ.raw_E4 > data/list/$train_set.list
fi
