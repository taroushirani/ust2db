...
full_align_dir = join(config["out_dir"], "full")
full_score_dir = join(config["out_dir"], "ust_full_seg")
...
black_list_file_path = join(config["out_dir"], "black.list")
...
for lab_align_path in full_lab_align_files:
    ...
    wav_path = join(config["out_dir"], "wav_seg", name + ".wav")
